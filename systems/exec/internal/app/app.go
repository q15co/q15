// Package app wires the q15-exec runtime into the gRPC server.
package app
...
import (
	...
	"github.com/q15co/q15/systems/exec/internal/service"
	"google.golang.org/grpc"
)

const (
	defaultListenAddr     = ":50051"
	defaultProxyAdminAddr = "q15-proxy:50052"
	defaultVersion        = "dev"
...
// Run validates args and starts the q15-exec runtime.
...
func validateArgs(args []string) error {
	...
	return errors.New("q15-exec accepts no arguments")
}
